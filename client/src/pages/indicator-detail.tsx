...
export default function IndicatorDetail() {
  ...
  const [isMobilePricing, setIsMobilePricing] = useState(false);
  ...
  useEffect(() => {
    ...
    const sync = () => setIsMobilePricing(media.matches);
    sync();
  ...
  const pricingPanelBody = (
    <>
            ...
            {(() => {
              ...
              return (
                <>
                  {savings > 0 && (
                    <p
                      className="text-[11px] leading-none text-muted-foreground line-through tabular-nums"
                      data-testid="text-dialog-original"
                    >
                  ...
                  <p
                    className="mt-0.5 break-words text-2xl font-bold tracking-tight"
                    data-testid="text-dialog-total"
                  >
                  ...
                  {savings > 0 && (
                    <p
                      className="mt-0.5 text-[10px] font-semibold text-emerald-500 tabular-nums"
                      data-testid="text-dialog-savings"
                    >
      ...
      {!canAddVersion(dialogVersion) && (
        <div
          className="mt-3 flex items-start gap-2 rounded-md border border-amber-500/30 bg-amber-500/10 p-2.5"
          data-testid="alert-dialog-mixed"
        >
          ...
          {(() => {
            ...
            return (
              ...
              >
                ...
                <span className="shrink-0 text-sm font-bold tracking-tight text-emerald-600 tabular-nums dark:text-emerald-400">
    ...
    <div className="min-h-screen">
      ...
      {isMobilePricing ? (
        ...
        >
          ...
          >
            <div className="flex min-h-0 flex-1 flex-col">
              <DrawerHeader className="gap-3 space-y-0 border-b border-card-border px-4 pb-4 pt-3 text-left">
                <div className="flex items-center justify-between gap-3">
                  ...
                  {!isFree && (
                    <div className="flex items-center gap-2">
                      <Label
                        htmlFor="switch-toggle-trial-mobile"
                ...
                <DrawerDescription className="sr-only">Select version, duration and add to cart.</DrawerDescription>
              </DrawerHeader>
              <div ref={pricingScrollRef} className="flex-1 overflow-y-auto p-4 pb-4">
                {pricingPanelBody}
              </div>
              <DrawerFooter className="shrink-0 border-t border-card-border bg-background p-4">
                {pricingPanelFooter}
              </DrawerFooter>
            </div>
          </DrawerContent>
        ...
        <Dialog open={pricingOpen} onOpenChange={setPricingOpen}>
          <DialogContent
            ref={pricingDialogRef}
            className="flex max-h-[92dvh] w-[calc(100vw-1rem)] max-w-md flex-col overflow-hidden rounded-xl p-0 sm:w-full"
          ...
          >
            <div className="flex min-h-0 flex-1 flex-col">
              ...
              <div className="shrink-0 border-t border-card-border bg-background p-4">
                {pricingPanelFooter}
              </div>
            </div>
          </DialogContent>
